export default function Hero() {
  return (
    <div className="w-full bg-hero-pattern bg-no-repeat bg-center bg-cover">
      <div className="p-6 sm:p-10 md:p-20 flex flex-col lg:flex-row justify-between items-center pt-24 sm:pt-36 md:pt-48 lg:pt-72 pb-20 sm:pb-30 md:pb-40 lg:pb-60">
